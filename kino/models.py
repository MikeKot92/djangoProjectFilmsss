...
class modelKino(models.Model):
    ...
    genre = models.ForeignKey(to=modelGenre, on_delete=models.SET_NULL, null=True,
                              verbose_name='Жанр')
    director = models.ForeignKey(to=modelDirector, on_delete=models.SET_NULL, null=True,
...
class modelOtziv(models.Model):
    user = models.ForeignKey(to=User, on_delete=models.SET_DEFAULT, default='user',
